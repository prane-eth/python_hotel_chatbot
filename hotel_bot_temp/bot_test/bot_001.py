...
def call_human(text):
	outp("Calling human.")   # add a feature
	# send_to_human(text)
...
def resp(msg):                      # for correct responses
	if msg in hlo:
		...
		outp("Wi-Fi password is VIT123. I repeat VIT123.")
	elif 'problem' in room:
...
emergencies
stop music while playing
calculations
translations for words
search for voice engines

Make a printed paper for instructions for user-(if needed)
add some content in what can you do
change voice engine
search good voice engine for Indian names
tour info-send content for Visakhapatnam
play music(1 added), news, sports updates
